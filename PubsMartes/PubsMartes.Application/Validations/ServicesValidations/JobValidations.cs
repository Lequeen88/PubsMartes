...
using PubsMartes.Application.Exeptions;
using PubsMartes.Application.Validations.ContractValidations;


namespace PubsMartes.Application.Validations.ServicesValidations
{
